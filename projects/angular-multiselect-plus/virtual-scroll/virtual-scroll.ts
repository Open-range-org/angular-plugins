...
export class VirtualScrollerComponent implements OnInit, OnChanges, OnDestroy {
	...
	protected getScrollElement(): HTMLElement {
		return (this.parentScroll instanceof Window ? document.scrollingElement || document.documentElement || document.body : this.parentScroll || this.element.nativeElement) as HTMLElement;
	}
	...
	protected calculateDimensions(): IDimensions {
		...
		if (this.isAngularUniversalSSR) {
			...
			let scrollOffset = (scrollElement as any)[this._scrollType] - (this.previousViewPort ? this.previousViewPort.padding : 0);
