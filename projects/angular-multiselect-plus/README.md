# Angular Multiselect Dropdown plus
...
## Getting Started
### Installation
- The Mutiselect Dropdown package is published on the [npm](https://www.npmjs.com/package/angular-multiselect-plus) Registry. 
- Install the package :
    `npm install angular-multiselect-plus`
...
```js
import { AngularMultiSelectModule } from 'angular-multiselect-plus';
...
- You need to include `default.theme.css` file to get the basic styling of the dropdown. 
- The component package has a themes folder in node_modules at `angular-multiselect-plus\themes\default.theme.css`
- Include the `default.theme.css` in `angular-cli.json` ;
...
##### Base package : https://github.com/CuppaLabs/angular2-multiselect-dropdown
## License
MIT License.
